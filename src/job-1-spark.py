...
df.write.format("parquet")\
        .mode("overwrite")\
        .save("s3a://stack-test-processing/df-parquet-file.parquet")

# lendo arquivos parquet
df_parquet = spark.read.format("parquet")\
 .load("s3a://stack-test-processing/df-parquet-file.parquet")
...
df_result.write.format("parquet")\
         .mode("overwrite")\
         .save("s3a://stack-test-curated/df-result-file.parquet")
